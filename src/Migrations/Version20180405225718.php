 ...
 */
class Version20180405225718 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, votes_id INT DEFAULT NULL, recipe_id INT DEFAULT NULL, published_at DATETIME NOT NULL, summary VARCHAR(255) NOT NULL, retailers VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, is_public_review TINYINT(1) NOT NULL, request_review_public TINYINT(1) NOT NULL, stars DOUBLE PRECISION NOT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_794381C6F675F31B (author_id), UNIQUE INDEX UNIQ_794381C65308DFC8 (votes_id), INDEX IDX_794381C659D8A214 (recipe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE review ADD CONSTRAINT FK_794381C65308DFC8 FOREIGN KEY (votes_id) REFERENCES app_users (id)');
